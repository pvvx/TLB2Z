 ...
 *      Author: pvvx
 */
#ifndef _BOARD_ZB_TS0001_H_
#define _BOARD_ZB_TS0001_H_

#include "version_cfg.h"

#if (BOARD == BOARD_ZB_TS0001)
#define BLE_MODEL_STR 			{"REL-BZ02"}
#define BLE_MAN_STR 			{"TLB2Z"}
#define BLE_NAME_PEFIX 			{'B','2','Z','-'} // fix 4 char
#define ZCL_BASIC_MODEL_ID		{8,'R','E','L','-','B','Z','0','2'} // REL-BZ02
...
// RELAY
#define GPIO_RELAY			GPIO_PD3
#define PD3_DATA_OUT		LED_OFF
...
#endif // BOARD == BOARD_ZV_TS0001
#endif /* _BOARD_ZB_TS0001_H_ */
