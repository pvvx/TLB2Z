...
#define FLASH_ADDR_OF_OTA_IMAGE		    (0x40000)
	...
	#define FLASH_OTA_IMAGE_MAX_SIZE	    (FLASH_ADDR_OF_OTA_IMAGE - FLASH_ADDR_OF_APP_FW - 0x2000)
#else
	//max size = (0x34000 - 0) = 204k
	#define FLASH_OTA_IMAGE_MAX_SIZE	    (NV_BASE_ADDRESS - FLASH_ADDR_OF_APP_FW - 0x2000)
#endif
